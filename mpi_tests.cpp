...
void myMat2x2Mul(const void* a_v, void* b_v, int len) {
    Mat2x2* a = (Mat2x2*) a_v;
    Mat2x2* b = (Mat2x2*) b_v;
    Mat2x2 mat;
    ...
    int i;
    for (i = 0; i < len; ++i) {
        mat.m00 = a[i].m00 * b[i].m00 + a[i].m01 * b[i].m10;
        mat.m01 = a[i].m00 * b[i].m01 + a[i].m01 * b[i].m11;
        mat.m10 = a[i].m10 * b[i].m00 + a[i].m11 * b[i].m10;
        mat.m11 = a[i].m10 * b[i].m01 + a[i].m11 * b[i].m11;
        b[i] = mat;
    }
}
